...
class StudentAnalyticsContent extends StatelessWidget {
  ...
  final int passedScans;
  final double averagePercent;
  final Map<String, Map<String, dynamic>> competencies;
  final bool loading;
  final String? error;
  ...
  Widget build(BuildContext context) {
    ...
    if (error != null) {
      return Container(
        ...
        child: Column(
          ...
          children: [
            Text(error!, style: const TextStyle(color: Color(0xFF8B1515))),
    ...
    final letterGrade = _letterGradeFromPercent(averagePercent);
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text(
                    '${overallMastery.toStringAsFixed(0)}% Mastery',
              ...
              Stack(
                children: [
                  ...
                  Container(
                    height: 8,
                    width: totalScans > 0 ? (MediaQuery.of(context).size.width - 48) * (overallMastery / 100) : 0,
                    decoration: BoxDecoration(
                      color: const Color(0xFF00E676),
                      borderRadius: BorderRadius.circular(4),
                    ),
              ...
              const SizedBox(height: 12),
              Text(
                'Calculated across $totalScans graded scans',
              ...
              Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      Text('${averagePercent.toStringAsFixed(0)}%', style: const TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
        ...
        if (competencies.isNotEmpty) ...[
          Row(
            ...
            children: [
              ...
              Text('$passedScans / $totalScans passed', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: primaryRed)),
            ],
          ),
          const SizedBox(height: 16),
          ...competencies.entries.map((entry) {
